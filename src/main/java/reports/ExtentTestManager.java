...
public class ExtentTestManager {
    ...
    // dùng để đính kèm hình ảnh vào trong report, mặc định satus = INFO
    ...
    // cũng dùng để đính kèm hình ảnh vào trong report nhưng có truyền trường "status" vô
    ...
    // Ghi log (ghi câu mô tả vào trong report đó)
